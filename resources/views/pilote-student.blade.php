...
<nav class="navbar">
        <ul>
            <li><a class="logo" href="pilote-companie"><img src="{{ asset('imgs/logopng.png')}}" alt=""></a></li>
            <div class="menu-nav">
                <li class="admin-menu"><a id="entreprisesButton" href="pilote-companie">ENTREPRISES</a></li>
                <li class="admin-menu"><a id="stagesButton" href="pilote-offer">STAGES</a></li>
                <li class="admin-menu"><a id="etudiantsButton" href="pilote-student">ETUDIANTS</a></li>
      ...
      <div class="popup">
        ...
        <form action="{{ route('ajouter-stage') }}" method="POST">
          <div class="side-form">
            ...
            <label for="codepostal">Promotion :</label>
            <input type="text" id="promo-input" name="promo" required maxlength=32>
          </div>
